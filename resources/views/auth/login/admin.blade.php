<div class="col-lg-4 col-md-6 ml-auto mr-auto" id="admin-section">
            ...
            <div class="card-body ">
                ...
                <div class="input-group">
                    ...
                    <input class="form-control{{ $errors->has('user_naam') ? ' is-invalid' : '' }}"
                        placeholder="{{ __('Username') }}" type="text" name="user_naam" value="{{ old('user_naam') }}"
                        required autofocus>

                    @if ($errors->has('user_naam'))
                    <span class="invalid-feedback" style="display: block;" role="alert">
                        <strong>{{ $errors->first('user_naam') }}</strong>
                    </span>
                    @endif
                </div>
